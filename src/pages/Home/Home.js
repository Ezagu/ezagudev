  ...
  return (
    <div className="home-content" id="home">
      ...
      <p className="home-desc">
        <span>Desarrollador web fullstack</span> en formación. Estudio
        Licenciatura en Informática mientras continúo ampliando mis
        conocimientos con diversos cursos. Me encuentro en{" "}
        <span>búsqueda activa</span> de mi primer empleo IT, con{" "}
        <span>total disponibilidad</span> y muchas ganas de seguir aprendiendo,
        crecer profesionalmente y aportar en proyectos reales.
      </p>
